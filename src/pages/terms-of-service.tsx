                ...
                <div className={styles.section}>
                    <div className={styles.content}>
                        ...
                        <p className="description small">
                            ...
                            content (qualified above) is authorized to be deleted by the action of server
                            ...
                            <br />- Upload of personal information is only allowed to uploaders with proper
                    ...
                    <div className={styles.section}>
                        <div className={styles.content}>
                            ...
                            <p className="description small">
                                ...
                                personal data defined above).
                            </p>

                            <p className="description small">
                                If you wish that an upload would be taken down as soon as possible please
