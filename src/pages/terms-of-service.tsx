            ...
            <div className={styles.section}>
                <div className={styles.content}>
                    ...
                    <p className="description small">
                        ...
                        form of prohibited content (qualified above) is authorized to be deleted by the action
                        of server administrator at any time.
                        <br />
                        <br />
                        ...
                        content <br />- Personal information is limited to uploaders with proper authorization
                        of their identity if needed.
                    </p>
                </div>
                ...
                <div className={styles.section}>
                    <div className={styles.content}>
                        ...
                        <p className="description small">
                            There is, of course, changes to our way of acting touching specific area of mode
                            of operation, which also includes changes to our way of acting to user specific
                            ...
                            none of previously mentioned data is deleted but saved for following thirty (30)
                            days. This is because the server administrator is authorized to be in full control
                            of data of the users who have clearly abused this service. This is not
                            discussable, because we are very strict of the possible abuse of this service.
                        </p>
                    </div>
                </div>
            </div>
